(function () {
  ...
  const files=allowed[grade]?.includes(subject)?(grade==='4'?['data/tests/4-tum-dersler.js',...(subject==='matematik'?['data/tests/4-matematik-zaman-olcme.js']:[])]:['data/tests/'+grade+'-'+subject+'.js']):[];
