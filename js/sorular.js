...
const SORULAR = {
  ...
  /* 4-matematik-zaman-olcme-zor */
  "4-matematik-zaman-olcme-zor": [
  {
    soru: "(5 Puan) Görselde bir okul projesi için çalışan üç farklı grubun görevlerini tamamlama süreleri ile ilgili bir çalışma alanı görülmektedir. Öğrenciler süreleri farklı birimlerle ifade etmiştir. Grupların süre dönüşümleri aşağıda verilmiştir: I. A grubu 2 saat 15 dakikada, yani toplam 135 dakikada bitirmiştir. II. B grubu 48 saatte, yani tam 2 günde bitirmiştir. III. C grubu 180 dakikada, yani tam 4 saatte bitirmiştir. Görseldeki grupların süre dönüşümlerinden hangileri doğru yapılmıştır?",
    secenekler: [
      "Yalnız I",
      "I ve III",
      "I ve II",
  ...
  {
    soru: "(5 Puan) Görselde eski çağlarda uzun mesafeli yolculuklar yapan bir seyyahın rotası ve tuttuğu notlar temsil edilmiştir. Bir seyyahın yolculuk notları incelenmektedir. Seyyahın uğradığı duraklar arasındaki seyahat süreleri şu şekilde ifade edilmiştir: I. Birinci bölüm 3 hafta sürmüş, yani 21 güne eşittir. II. İkinci bölüm 72 ay sürmüş, yani 5 yıla eşittir. III. Üçüncü bölüm 2 yıl sürmüş, yani 24 aya eşittir. Görseldeki bilgiler ve verilen bu seyahat süreleri ile ilgili hangi dönüşümler doğrudur?",
    secenekler: [
      "I ve II",
      "I ve III",
      "Yalnız I",
  ...
  {
    soru: "(5 Puan) Usta bir aşçı, yeni tarifini hazırlarken her bir aşamanın ne kadar sürdüğünü detaylı bir şekilde not etmiştir. Bir kekin yapım ve dinlenme aşamaları için verilen süreler incelenmiştir: I. Pişirme süresi 45 dakika, yani 2700 saniyedir. II. Soğuma süresi yarım saat, yani 15 dakikadır. III. Dinlenme süresi 2 saat, yani 120 dakikadır. Bu sürelerden hangilerinin çevirisi doğru hesaplanmıştır?",
    secenekler: [
      "Birinci ve İkinci",
      "Yalnız Birinci",
      "Yalnız Üçüncü",
  ...
  {
    soru: "(5 Puan) Zaman birimlerini birbirine dönüştürmek, günlük planlarımızı doğru yapmamızı sağlar. Bir saat 60 dakika, bir gün 24 saat ve bir hafta 7 gündür. Verilen görselde zaman birimleri arasındaki dönüşümlerle ilgili bazı çalışmalar yapan öğrenciler şu ifadeleri kullanmışlardır: I. 1 gün 12 saat toplam 36 saattir. II. 3 saat 15 dakika toplam 195 dakikadır. III. 2 hafta 4 gün toplam 16 gündür. IV. 150 dakika, 2 saat 30 dakikaya eşittir. Bu ifadelerden kaç tanesi doğru hesaplanmıştır?",
    secenekler: [
      "1",
      "2",
      "3",
  ...
  {
    soru: "(5 Puan) Verilen görselde bir dağ maratonuna katılan koşucuların parkuru tamamlama süreleri hakemler tarafından farklı zaman ölçüleri kullanılarak kaydedilmiştir. Bu sporcuların koşu parkurunu bitirme süreleri hakkında şu bilgiler verilmiştir: I. Birinci sporcu 150 dakikada, yani 2 saat 30 dakikada bitirmiştir. II. İkinci sporcu 3 saat 10 dakikada, yani 190 dakikada bitirmiştir. III. Üçüncü sporcu 400 saniyede, yani 4 dakikada bitirmiştir. Görseldeki bilgiler ve verilenler ışığında, bu sporcuların süreleriyle ilgili hangisi yanlıştır?",
    secenekler: [
      "Yalnız Birinci",
      "Yalnız İkinci",
      "Yalnız Üçüncü",
  ...
  {
    soru: "(5 Puan) Görselde görülen canlıların gelişim evreleri türden türe farklılık gösterir. Veterinerler bu süreleri takip ederken birimleri birbirine çevirmek zorundadır. Görseldeki hayvanların büyüme süreleri şöyledir: Kedi 65 gün, Köpek 10 hafta ve Tavşan 2 ay. Bu bilgilere göre büyüme sürelerinin uzundan kısaya doğru sıralanışı hangisidir? (1 ay 30 gün alınacaktır)",
    secenekler: [
      "Köpek, Tavşan, Kedi",
      "Kedi, Köpek, Tavşan",
      "Köpek, Kedi, Tavşan",
  ...
  {
    soru: "(5 Puan) Etkinliklerin başlangıç ve bitiş saatlerini hesaplamak için zaman ölçme birimleriyle işlemler yaparız ve geçen süreyi buluruz. Görselde belirtilen spor turnuvasındaki maçların süreleri ile ilgili aşağıdaki ifadeler verilmiştir: I. Birinci maç 14.30‛da başlayıp 16.15‛te bittiyse, maç 1 saat 45 dakika sürmüştür. II. İkinci maç 90 dakika sürmüştür ve 18.00‛da bitmiştir, demek ki maç 16.30‛da başlamıştır. III. Üçüncü maç 1 saat 50 dakika sürmüştür ve toplam 100 dakikadır. IV. Dördüncü maç 15.45‛te başlayıp 120 dakika sürmüşse, 17.45‛te bitmiştir. Verilen ifadelerden hatalı olanın numarası aşağıdakilerden hangisidir?",
    secenekler: [
      "IV",
      "I",
      "III",
  ...
  {
    soru: "(5 Puan) Görselde internet üzerinden yayın yapan çeşitli bilim ve kültür dergilerinin abonelik paketleri temsil edilmiştir. Bu dergilerin abonelik süreleri şöyledir: Bilim dergisi 2 yıl 4 ay, Doğa dergisi 29 ay ve Sanat dergisi 104 hafta süreyle abonelik imkanı sunmaktadır. Görseldeki verileri ve verilen bilgileri inceleyerek, en uzun ve en kısa abonelik sürelerinin hangi dergilere ait olduğunu belirleyiniz. (1 ay 4 hafta olarak hesaplanacaktır.)",
    secenekler: [
      "En uzun Sanat, en kısa Doğa",
      "En uzun Doğa, en kısa Sanat",
      "En uzun Bilim, en kısa Sanat",
      "En uzun Doğa, en kısa Bilim"
    ],
    dogru: 0,
    aciklama: ""
  },
  {
    soru: "(5 Puan) Seyahat planı yaparken hareket ve varış saatlerini içeren tabloları doğru okumak ve geçen süreyi hesaplamak çok önemlidir. Aşağıdaki tablo üç farklı otobüsün bir şehirden diğerine gidiş sürelerini göstermektedir: Otobüs Kalkış Saati Varış Saati Kırmızı 08.15 11.45 Mavi 09.30 12.10 Yeşil 10.45 14.30 Bu tabloya göre otobüslerin yolculuk süreleri ile ilgili aşağıdakilerden hangisi doğrudur?",
    secenekler: [
      "Yeşil otobüsün yolculuğu tam dört saat sürmüştür.",
      "Yeşil otobüsün yolculuğu Mavi otobüsten kısa sürmüştür.",
      "Kırmızı otobüsün yolculuğu tam üç saat sürmüştür.",
      "Mavi otobüsün yolculuğu üç saatten kısa sürmüştür."
    ],
    dogru: 0,
    aciklama: ""
  },
  {
    soru: "(5 Puan) Bir uzay aracı başka bir gezegene ulaşmak için uzayda uzun bir yolculuk yapmıştır. Yolculuğun ilk aşaması tam 4 ay, ikinci aşaması ise 125 gün sürmüştür. Bu uzay aracının toplam yolculuğu kaç hafta sürmüştür? (1 ayı 30 gün olarak hesaplayınız.)",
    secenekler: [
      "33 hafta",
      "32 hafta",
      "34 hafta",
