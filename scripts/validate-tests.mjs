...
validateGroup(3, "turkce", 24, 8);
validateGroup(3, "hayat-bilgisi", 18, 6);
validateGroup(3, "fen-bilimleri", 24, 8);
validateGroup(3, "ingilizce", 18, 6);
validateGroup(4, "turkce", 15, 5);
validateGroup(4, "matematik", 42, 14);
validateGroup(4, "hayat-bilgisi", 12, 4);
validateGroup(4, "fen-bilimleri", 21, 7);
validateGroup(4, "sosyal-bilgiler", 21, 7);
validateGroup(4, "ingilizce", 18, 6);
