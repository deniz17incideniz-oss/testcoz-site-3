...
(function () {
  ...
  const grade3Names = ["Değerlerimizle Yaşıyoruz", "Atatürk ve Kahramanlarımız", "Doğayı Tanıyoruz", "Bilgi Hazinemiz", "Yeteneklerimizi Kullanıyoruz", "Bilim Yolculuğu", "Millî Kültürümüz", "Hak ve Sorumluluklarımız"];
  Object.keys(themes).forEach(function (key, index) { themes[key].name = grade3Names[index]; });
  ...
  Object.keys(themes).forEach(function (topic) {
    ...
    difficulties.forEach(function (difficulty) {
      const slug = "3-sinif-turkce-" + topic + "-" + difficulty + "-test-1";
