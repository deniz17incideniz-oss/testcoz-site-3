  ...
  const banks = {
    "sayilar-ve-nicelikler": {
      ...
      zor: [
        ...
        q("Nehir 100'e kadar onar sayarken bir kartı ters çevirdi: 30, 40, ?, 60. Ters çevrilen kartta hangi sayı vardır?", ["45", "50", "55", "70"], "50", "Onar sayma dizisi 30, 40, 50, 60'tır."),
    ...
    "uzunluk-ve-kutle-olcme": {
      ...
      orta: [
        ...
        q("Ölçüm çiziminde ilk üç blok uç uca, son blok arada boşluk bırakılarak konulmuştur. Bu ölçüm için hangisi doğrudur?", ["Tam doğrudur", "Boşluk nedeniyle sonuç hatalıdır", "Blok sayısı değişmez", "Nesne ağırdır"], "Boşluk nedeniyle sonuç hatalıdır", "Birimler arasında boşluk kalırsa nesnenin tamamı eş birimlerle ölçülmüş olmaz.", visual("measurementError", "Ölçüm hatasını bul", { units: 4, gapAfter: 3 } ))
      ],
      zor: [
        ...
        q("Bir çocuk aynı uzunluğu ölçerken eş blokları uç uca koymak yerine üst üste bindiriyor. Kullandığı blok sayısı doğru ölçüme göre nasıl değişir?", ["Artar", "Azalır", "Hiç değişmez", "Ağırlık artar"], "Artar", "Bloklar üst üste gelince her yeni blok daha az uzunluk kaplar; aynı uzunluğu kaplamak için daha çok blok gerekir.", visual("measurementError", "Üst üste binen birimler", { units: 5, overlap: true } ))
      ]
    },
    ...
    "konum-ve-es-nesneler": {
      kolay: [
        ...
        q("Görselde dört şekilden hangileri birbirinin eşidir?", ["A ile B", "A ile C", "B ile D", "C ile D"], "A ile C", "A ve C aynı renk, şekil ve büyüklüktedir.", visual("matching", "Eşini bul", { items: [{ id: "A", kind: "star", color: "blue" }, { id: "B", kind: "circle", color: "red" }, { id: "C", kind: "star", color: "blue" }, { id: "D", kind: "star", color: "green" }] }))
      ],
      orta: [
